    ...
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          >
            <Text style={styles.courseTitle}>{'07/06/2023 10:40 PM'}</Text>
            <View style={styles.priceRatingContainer}>
              <Text style={[styles.textStyle, styles.price]}>+34 372 180 155</Text>
              <Text style={styles.textStyle}>94.8% </Text>
              <Icon name="warning" size={24} color="rgb(0, 182, 240)" />
            </View>
            <Animated.View
            ...
            >
            <Animated.Text
              style={[styles.courseDescription, { opacity: opacity2.current, paddingBottom: 40}]}
              numberOfLines={3}
            >
              Haz dinero en línea 200-500 euros por día Experiencia laboral ilimitada, enseñanza uno a uno, operación simple y conveniente. agregue  rebrand.ly/af82b7
            </Animated.Text>
              <View style={styles.BtnMultisources}>
                <MyPressable>
                  <Text style={styles.MultisourcesText}>Others Third-Party AI ML:</Text>
                </MyPressable>
              </View>
              {getTimeBoxUI('ChatGPT \(Powered by OpenAI\)', 'Based on the content of the message, it appears to be a spam message promoting an online money-making scheme, and should be treated with caution.')}
              {getTimeBoxUI('Bard \(Powered by Google\)', 'Sure. The message content "Haz dinero en línea 200-500 euros por día Experiencia laboral ilimitada, enseñanza uno a uno, operación simple y conveniente. agregue rebrand.ly/af82b7" is a **spam message**. It is trying to sell you a job opportunity that promises you to make a lot of money online.')}
            </Animated.View>
          </ScrollView>
          <Animated.View
            style={[
          ...
          >
            <View style={styles.joinCourse}>
              <MyPressable>
                <Text style={styles.joinCourseText}>Report if not accurate</Text>
              </MyPressable>
            </View>
          </Animated.View>
        </View>
