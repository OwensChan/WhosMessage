...
const CATEGORIES = ['Spam', 'Phishing scams', 'Smishing attacks'];
...
const HomeDesignCourse: React.FC = () => {
  ...
  const renderScrollableHeader = (
    <>
      <View style={[styles.searchInputMainContainer, { width: width * 0.75 }]}>
        <View style={styles.searchInputContainer}>
          <TextInput
            ...
            placeholder="Search for Short Messages"
          />
      ...
      />
      <Text style={styles.sectionHeaderText}>List All Messages</Text>
    </>
  );
    ...
    <View style={{ flex: 1, backgroundColor: 'white', paddingTop }}>
      ...
      <View style={styles.header}>
        <View style={{ flex: 1, justifyContent: 'center' }}>
          <Text style={styles.headerTextNormal}>List your</Text>
          <Text style={styles.headerTextBold}>Short Messages</Text>
        </View>
        <Image
