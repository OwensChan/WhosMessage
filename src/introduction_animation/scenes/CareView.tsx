  ...
  return (
    ...
    >
      ...
      <Text style={styles.subtitle}>
        We are not only using our proud Machine Learning algorithm, but also
        using the most famous technology - ChatGPT (Powered by OpenAI) and {'\n'}Bard (Powered by Google)
      </Text>
    </Animated.View>
  );
};
